...
analogous to the environments of high-redshift galaxies \citep{Kruijssen2013a},
in which most stars formed. The centers of disk galaxies have more scattered
efficiencies than disks
...
Assessing how gas forms stars in the CMZ requires high-resolution data at long
wavelengths.  Over the next decade, the key instruments for these programs will
be the Atacama Large Millimeter/submillimeter Array (ALMA) and the JWST.
Toward the end of the decade, the Next Generation Very Large Array (ngVLA) and
Origins Space Telescope (OST) will contribute significantly.
% TODO: highlight an ngVLA and/or an OST science case: this may help inform
% their project development (somewhat independent of but prompted by the
% decadal)  EDIT: nope, we have that below
...
proposed ALMA CMZ Exploration Survey (ACES, PI Longmore) is needed to directly
measure the star formation rate via the counting of protostellar cores. Such a
survey will also provide both the gas density and kinematic measurements that
characterize the turbulence and link the gas and stars.

Connecting the large scales mentioned above to the scales of individual stars
requires large-area maps with sensitivity to all angular scales. It remains
unclear whether galactic center starbursts are driven by a gradual build-up of
gas at a galactocentric radius set by the rotation curve \citep{Krumholz2015c},
or instead if there are specific temporal and spatial triggers for local bursts
as large clouds are fed in along the bar \citep{Bally2010a,Sormani2018b}. The
combination of detailed measurements of the star formation efficiency and
timescales \citep[e.g.][]{Kruijssen2015a,Barnes2017b,Jeffreson2018b} with
large-area single-dish maps of both infalling and CMZ material
...
properties, enabling kinematic mass measurements of protostars.
% if we're REALLY lucky in terms of scoping...
If the OST design is high enough spatial resolution, it will provide the
critical measurements of the far-infrared peak of the protostellar SEDs needed
to measure the source luminosities.
% OST will provide arcsecond-resolution maps of the dust column density and
% temperature, which will allow complete systematic measurements of the core
% mass distrib

Large-scale mapping of CMZ gas will enable comparison of our Galactic center to
nearby galaxies \citep[e.g.][]{Leroy2018a}.  While improved resolution is
...
surveys provide the link to extragalactic systems. Recent and ongoing ALMA
...
of the Galactic work to universal scales.
