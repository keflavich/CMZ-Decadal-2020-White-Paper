...
actively forming stars. It is the only location suitable for studying star formation in hot \citep{Ao2013a, Ginsburg2016a, Krieger2017a}, high-pressure molecular gas
analogous to the environments of high-redshift galaxies \citep{Kruijssen2013a}, in which most stars formed. The centers of disk galaxies have more scattered efficiencies than disks \citep{Leroy2013a,Usero2015a,Bigiel2016a,Gallagher2018a}, suggesting that galaxy centers undergo episodic cycles of bursty star formation and quiescence \citep[e.g.][]{Kruijssen2014a,Krumholz2017a}.
...
\citep{Krumholz2015a,Sormani2015a,Torrey2016a,Ridley2017a,Krumholz2017a,Sormani2018a,Jeffreson2018b}
...
and may be driven primarily by stellar feedback \citep[e.g.][]{Davies2007a,Kruijssen2017a,Sormani2018b}. The infall through the final few parsecs is mediated by the circumnuclear disk \citep[CND; e.g.,]{Takekawa2017a,Hsieh2017a}), which contains molecular and ionized gas at temperatures and densities seen nowhere else in the Galaxy.

Key questions about each step of the above inflow process that can be solved in the next decade include:
\begin{enumerate}
    \item 
...
coarse resolution. While these observations are useful for bulk mass inflow measurements \citep[e.g.][]{Sormani2019a}, they are inadequate for measurements of turbulence and star formation. Single-dish molecular line surveys at moderate
...
clouds. This also requires continued development of the statistical tools to link gas kinematics and density distributions with the underlying physics \citep{Koch2017a,Burkhart2018a}. While multi-pixel heterodyne arrays are the
...
inward and builds up until reaching some threshold and forming stars \citep{Kruijssen2014a,Krumholz2017a,Sormani2018b}.  Shortly
...
outflow. How much of this gas is turned into stars, how much is driven out of the Galactic center by feedback, and how much is driven towards the central black hole?
\end{enumerate}
...
\citep{Law2009a,Law2010a}. Tracking the present-day gas flow is critical
...
rest of the Galaxy.  Most of the gas mass is in a molecular state \citep[need
to cite others][]{Mills2017a}, and the temperature in the molecular gas is
...
closely reflect those seen at the peak of the cosmic star formation history, implying that the CMZ best represents the dominant conditions for star formation in the Universe \citep{Kruijssen2013a}. There is growing evidence that the IMF in the Galactic center massive clusters, the
...
\citep{Rathborne2014a,Kruijssen2014a,Walker2017a,Barnes2017b,Ginsburg2018a}.

Assessing how gas forms stars in the CMZ requires high-resolution data at long wavelengths.  Over the next decade, the key instruments for these programs will be the Atacama Large Millimeter/submillimeter Array (ALMA) and the JWST.  Toward the end of the decade, the Next Generation Very Large Array (ngVLA) and Origins Space Telescope (OST) will contribute significantly.
...
CMZ constitutes the most confused and extincted line of sight in the galaxy, so
the mid-infrared Spitzer survey has been deeply ineffective at measuring star
formation in this region \citep{Koepferl2014a}. Individual ALMA programs have
begun to tally the protostars \citep[I'd like to cite others here, but it's all
still in prep, right?]{Ginsburg2018a} and the SMA has completed a systematic
survey \citep{Battersby2016a}. However, a systematic, deep survey, such as the
proposed ALMA CMZ Exploration Survey (ACES, PI Longmore) is needed to directly measure the star formation rate via the counting of protostellar cores. Such a survey will also provide both the gas density and kinematic measurements that characterize the turbulence and link the gas and stars.

Connecting the large scales mentioned above to the scales of individual stars requires large-area maps with sensitivity to all angular scales. It remains unclear whether galactic center starbursts are driven by a gradual build-up of gas at a galactocentric radius set by the rotation curve \citep{Krumholz2015a}, or instead if there are specific temporal and spatial triggers for local bursts as large clouds are fed in along the bar \citep{Bally2010a,Sormani2018b}. The combination of detailed measurements of the star formation efficiency and timescales \citep[e.g.][]{Kruijssen2015a,Barnes2017b,Jeffreson2018b} with large-area single-dish maps of both infalling and CMZ material \citep[e.g.][]{Sormani2019a} will answer this question.
...
properties, enabling kinematic mass measurements of protostars. % if we're REALLY lucky in terms of scoping...
If the OST design is high enough spatial resolution, it will provide the critical measurements of the far-infrared peak of the protostellar SEDs needed to measure the source luminosities.
% OST will provide arcsecond-resolution maps of the dust column density and temperature, which will
% allow complete systematic measurements of the core mass distirb

Large-scale mapping of CMZ gas will enable comparison of our Galactic center to
nearby galaxies \citep[e.g.][]{Leroy2018a}.  While improved resolution is needed to extract a detailed understanding of the physical mechanisms and stellar-system-scale effects that are important in this region, large-area surveys provide the link to
extragalactic systems. Recent and ongoing ALMA surveys are providing tens of parsec-scale observations of nearby galaxies covering large areas with a few lines (PHANGS-ALMA, Leroy et al.\ to be submitted) or CMZ-scale areas across the entire millimeter spectrum (ALCHEMI). Analogous data sets covering our own CMZ are needed to enable the application of the Galactic work to universal scales.
